/*! For license information please see main.6496de50.js.LICENSE.txt */
!(function () {
  var e = {
      463: function (e, n, t) {
        var r = t(791),
        ...
        function _s(e, n, t) {
          ...
          null !== r && r.delete(n),
            ...
            zi === e &&
              (Li & t) === t &&
              (4 === Mi ||
              (3 === Mi && (130023424 & Li) === Li && 500 > Ge() - Ai)
                ? ds(e, 0)
                : (ji |= t)),
            rs(e, n);
        }
  ...
  !(function () {
    var e = t(791),
      ...
      a = function () {
        return (0, r.jsx)("div", {
          className: "footer-copyright blue lighten-3",
          children: (0, r.jsxs)("div", {
            className: "container",
            style: { textAlign: "center" },
            children: ["\xa9 ", new Date().getFullYear(), " My App"],
          }),
        });
      };
    function o(e, n) {
    ...
    var m = function (e) {
            ...
            children: (0, r.jsxs)("div", {
              ...
              children: [
                (0, r.jsxs)("div", {
                  ...
                  children: [
                    (0, r.jsx)("img", {
                      alt: "",
                      src:
                        "N/A" == a ? "https://via.placeholder.com/300x150 " : a,
                    }),
                ...
                (0, r.jsxs)("div", {
                  ...
                  children: [
                    (0, r.jsx)("p", { className: "title-movie", children: t }),
      ...
      v = function (e) {
        return (0, r.jsx)("div", {
          ...
          children: e.list.map(function (e) {
            return (0, r.jsx)(m, { movie: e }, e.imdbID);
          }),
        });
      },
      g = function () {
        return (0, r.jsx)("div", {
          children: (0, r.jsx)("div", {
            className: "progress",
            children: (0, r.jsx)("div", { className: "indeterminate" }),
          }),
        });
      },
      y = (function (e) {
        ...
        function t(e) {
          ...
          return (
            o(this, t),
            ((r = n.call(this, e)).handleRadioChange = function (e) {
              r.setState({ paramSearch: e.target.dataset.type }),
                r.props.typeMovie(e, e.target.dataset.type);
            }),
            (r.state = { paramSearch: "" }),
            r
          );
                      ...
                      children: (0, r.jsxs)("label", {
                        children: [
                          (0, r.jsx)("input", {
                            ...
                            name: "type",
                            "data-type": "",
                            checked: "" == this.state.paramSearch,
                            onChange: this.handleRadioChange,
                          }),
                          (0, r.jsx)("span", { children: "All" }),
                        ],
                      }),
                    }),
                    (0, r.jsx)("p", {
                      children: (0, r.jsxs)("label", {
                        children: [
                          (0, r.jsx)("input", {
                            ...
                            "data-type": "movie",
                            onChange: this.handleRadioChange,
                            checked: "movie" == this.state.paramSearch,
                          }),
                          (0, r.jsx)("span", { children: "Movies" }),
                        ],
                      }),
                    }),
                    (0, r.jsx)("p", {
                      children: (0, r.jsxs)("label", {
                        children: [
                          (0, r.jsx)("input", {
                            ...
                            "data-type": "series",
                            onChange: this.handleRadioChange,
                            checked: "series" == this.state.paramSearch,
                          }),
                          (0, r.jsx)("span", { children: "Serails" }),
                        ],
                      }),
                    }),
                  ],
      ...
      b = (function (e) {
        ...
        function t(e) {
          ...
          return (
            o(this, t),
            ((r = n.call(this, e)).handleChange = function (e, n) {
              r.props.setMovies(r.state.searchValue || "marvel", n);
            }),
            (r.state = { searchValue: "" }),
            r
          );
              ...
              value: function () {
                ...
                return (0, r.jsxs)("div", {
                  ...
                  children: [
                    (0, r.jsxs)("div", {
                      ...
                      children: [
                        (0, r.jsx)("input", {
                          ...
                          onChange: function (n) {
                            return e.setState({ searchValue: n.target.value });
                          },
                          id: "first_name2",
                          type: "text",
                          placeholder: "Search",
                        ...
                        (0, r.jsx)("a", {
                          onClick: function (n) {
                            n.preventDefault(), e.handleChange();
                          },
                    ...
                    (0, r.jsx)(y, { typeMovie: this.handleChange }),
                  ],
                });
              },
            },
      ...
      w = (function (e) {
        ...
        function t(e) {
          ...
          return (
            o(this, t),
            ((r = n.call(this, e)).getMovies = function () {
              var e =
                ...
                fetch(
                  ...
                  .then(function (e) {
                    r.setState({ loading: !1 }),
                      console.log(e),
                      e.Error
                        ? r.setState({ notFound: !0 })
                        : (r.setState({ movies: e.Search }),
                          r.setState({ notFound: !1 }));
                  });
            }),
            (r.state = { movies: [], notFound: !1, loading: !1 }),
            r
          );
        }
        return (
            ...
            },
            {
              ...
              value: function () {
                return (0, r.jsxs)("div", {
                  ...
                  children: [
                    (0, r.jsx)(b, { setMovies: this.getMovies }),
                    this.state.loading ? (0, r.jsx)(g, {}) : null,
                    this.state.notFound
                      ? (0, r.jsx)("h1", { children: "Not found" })
                      : (0, r.jsx)(v, { list: this.state.movies }),
                  ],
                });
              },
            },
    ...
    var x = function () {
      return (0, r.jsxs)("div", {
        className: "App",
        children: [(0, r.jsx)(l, {}), (0, r.jsx)(S, {}), (0, r.jsx)(a, {})],
      });
    };
...
//# sourceMappingURL=main.6496de50.js.map
